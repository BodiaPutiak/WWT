...
export const CustomModal: React.FC<CustomModalProps> = ({ isOpen, onClose, filterItems, selectedOptions, handleCheckboxChange, handleApply, handleClearAll }) => {
  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={onCloseWithConfirmation}>
        <ModalOverlay />
        <ModalContent>
          <ModalCloseButton />
          ...
          <ModalBody>
            ...
            <Box mt={4}>
              ...
              <Link ml={4} onClick={handleClearAll}>{t('filters.clearAll')}</Link>
            </Box>
          </ModalBody>
        </ModalContent>
      </Modal>
